                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            ?>
                              <tr>
                                <td>&nbsp<?php echo $id?> ( <?php echo $cx?> , <?php echo $cy?>  )
                                <span class="pull-right"><a href="titik-pusat.php?id=<?php echo $id;?>" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-pencil"></i> Edit</a></span>
                                </td>
                              </tr>
                              <?php }?>
                            </tbody>
