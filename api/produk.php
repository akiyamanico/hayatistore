                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $hg;?></td>
                                        <td class="center">
                                            <a class="btn btn-xs btn-warning" href="produk-edit.php?id=<?php echo $id;?>">
                                            	<i class="fa fa-pencil"></i> Edit
                                            </a>
                                            <a class="btn btn-xs btn-danger" href="produk-hapus.php?id=<?php echo $id;?>&nm=<?php $lnm = str_replace(' ','-',$nm); echo $lnm;?>" onclick="return confirm('Apakah anda yakin menghapus data ini ?')"> <i class="fa fa-trash"></i> Hapus
                                            </a>
                                        </td>
                                    </tr>
                                    <?php } ?>
